...
object NetworkModule {
  ...
  @Provides
    ...
    @Provides
    @Singleton
    fun provideStylingApi(retrofit: Retrofit): com.apptive.wotd.model.recommend.StylingApi {
        return retrofit.create(com.apptive.wotd.model.recommend.StylingApi::class.java)
    }
}
